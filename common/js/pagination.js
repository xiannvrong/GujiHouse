var Pagination = {
	...
	createHtml: function(pageIndex, recordCount, pageSize) {
		...
		html.push("<span class=\"page_jump\">前往</span><input id='pageInput' class='pageInput' oldpage='' maxlength='" + pageCount + "' type='text' ><span class=\"page_jump\">頁</span><button type='button' id='pagebtn' class='pagebtn'>确定</button>");
		return html.join("");
	},
	bindListener: function(obj, callback, topFlag) {
		...
		function changePage() {
            ...
            console.log(obj.find(".total_page").html())
			var maxPage = parseInt(obj.find(".total_page").html());
